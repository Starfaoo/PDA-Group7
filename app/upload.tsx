        ...
        {selectedImage ? (
          ...
          <View style={styles.placeholderContainer}>
            ...
            <Text style={styles.subtitle}>
              Take a clear photo or upload an image of the plant leaf you want to analyze
            </Text>
          </View>
        )}
      </View>
      ...
      <View style={styles.footer}>
        {selectedImage ? (
          ...
          <>
            ...
            <TouchableOpacity style={styles.secondaryBtn} onPress={() => setSelectedImage(null)}>
              <Feather name="upload" size={20} color="#333" style={{ marginRight: 8 }} />
          ...
          <>
            <TouchableOpacity style={styles.primaryBtn} onPress={() => pickImage(true)}>
              <Ionicons name="camera-outline" size={24} color="white" style={{ marginRight: 8 }} />
              <Text style={styles.primaryText}>Take Photo</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.secondaryBtn} onPress={() => pickImage(false)}>
              <Feather name="upload" size={20} color="#00C853" style={{ marginRight: 8 }} />
              <Text style={[styles.secondaryText, { color: '#00C853' }]}>Upload from Gallery</Text>
            </TouchableOpacity>
          </>
        )}
      </View>
